...
@router.get("/v1/system/health/ping", tags=["v1/health"], include_in_schema=sys_config.expose_gui_api)
...
@router.get("/v1/system/health/check", tags=["v1/health"], include_in_schema=sys_config.expose_gui_api)
