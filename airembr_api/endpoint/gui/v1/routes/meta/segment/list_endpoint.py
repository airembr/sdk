...
from airembr.system.command.v1.list.segment.list import (
...
@router.get("/v1/segments", tags=["v1/segment"], include_in_schema=sys_config.expose_gui_api)
...
@router.get("/v1/segments/meta", tags=["v1/segment"], include_in_schema=sys_config.expose_gui_api)
