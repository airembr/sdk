...
from airembr.system.command.v1.list.canonical_entity.list import (
...
@router.get("/v1/canonical-entities", tags=["v1/ontology"],
            include_in_schema=sys_config.expose_gui_api)
async def list_canonical_entities(query: Optional[str] = None, limit: int = 100, start: int = 0, output: str = 'entity'):
...
@router.get("/v2/canonical-entity-properties/{entity_id}", tags=["ontology"],
            include_in_schema=sys_config.expose_gui_api)
