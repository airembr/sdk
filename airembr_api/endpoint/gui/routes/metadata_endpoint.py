...
async def list_event_entity_names():
...
async def list_entity_object_names():
...
async def list_entity_object_properties(entity_type: str, filter: str = None, event_type=None, actor=None,
...
async def list_named_event_types(limit: int = 1000, entity_type: str = None):
    """
    Returns event types
    """
...
async def list_named_event_actors(limit: int = 1000, entity_type: str = None):
    """
    Returns event types
    """
...
async def list_fact_traits_by_type(event_type: str):
