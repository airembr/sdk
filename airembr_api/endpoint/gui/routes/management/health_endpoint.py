...
@router.post("/healthcheck", tags=["health"], include_in_schema=sys_config.expose_gui_api)
...
@router.put("/healthcheck", tags=["health"], include_in_schema=sys_config.expose_gui_api)
...
@router.delete("/healthcheck", tags=["health"], include_in_schema=sys_config.expose_gui_api)
